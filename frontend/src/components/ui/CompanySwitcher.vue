...
<template>
  <div class="relative">
    <button
      ...
      class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 text-left min-w-[180px]"
    >
    ...
    <div
      v-if="open"
      @click.stop
      class="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg border border-gray-100 py-1 min-w-[180px] z-50"
    >
      <button
